...
""".strip()
    ...
    def generate_report(
        ...
        # Calculate metrics
        runs_per_week = workflow_data['runs_count'] * 7 / workflow_data['analysis_days'] if workflow_data['analysis_days'] > 0 else 0
        activity_level = "🔥 High" if runs_per_week > 20 else "📊 Medium" if runs_per_week > 5 else "📉 Low"
            ...
            if recs:
                ...
                for i, rec in enumerate(recs, 1):
                    ...
                    section_recs.append({
                        ...
                        'title': rec['title'],
                        'workflow': rec.get('workflow_file', rec.get('workflow', 'Multiple files')),
